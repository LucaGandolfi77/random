...
OPENROUTER_MODEL_PROFILES = {
    "low-cost": "google/gemini-2.0-flash-lite-001",
...
class OpenRouterProvider(LLMProvider):
    def __init__(self, settings: Settings, cache: CacheProtocol | None = None) -> None:
        ...
        self.cache = cache
        self.model = settings.openrouter_model or OPENROUTER_MODEL_PROFILES.get(settings.openrouter_profile, "google/gemini-2.0-flash-lite-001")
